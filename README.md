...
```
git clone https://github.com/ryancarr/CppND-Route-Planning-Project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:ryancarr/CppND-Route-Planning-Project.git --recurse-submodules
```
